      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-20 max-w-container-max mx-auto px-margin-desktop text-center">
          <h1 className="font-display text-4xl md:text-6xl font-extrabold text-primary mb-6 max-w-4xl mx-auto leading-tight">
            {settings?.homepage?.heroTitle || 'Building the Future with'} <span className="text-secondary">Precision & Innovation</span>
          </h1>
      ...
      <section className="py-160px bg-surface-container-low">
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-display text-3xl font-bold text-primary mb-8">What Global Leaders Say</h2>
        ...
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <div className="bg-primary rounded-3xl p-12 md:p-20 relative overflow-hidden text-center text-on-primary shadow-2xl">
            <div className="relative z-10">
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">Ready to Start Your Next Milestone?</h2>
              <p className="font-sans text-lg opacity-80 max-w-2xl mx-auto mb-10">
                Consult with our experts across Architectural Design, Geotechnical Engineering, and Infrastructure Construction.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <a href={`https://wa.me/${settings?.whatsappNumber || '971500000000'}`} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white px-10 py-5 rounded-lg font-display font-semibold hover:opacity-90 transition-all flex items-center justify-center gap-3 w-full sm:w-auto">
