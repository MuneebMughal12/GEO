...
/**
 * Automatically seeds default data for all collections if they are empty.
 */
const autoSeed = async () => {
  try {
    ...
    if (companyCount === 0) {
      ...
      console.log('--- AUTO-SEED: Companies seeded');
    }
    ...
    if (serviceCount === 0) {
      ...
      console.log('--- AUTO-SEED: Services seeded');
    }
    ...
    if (projectCount === 0) {
      ...
      console.log('--- AUTO-SEED: Projects seeded');
    }
    ...
    if (teamCount === 0) {
      ...
      console.log('--- AUTO-SEED: Team members seeded');
    }

    // 7. Seed Gallery
    const galleryCount = await GalleryMedia.countDocuments();
    if (galleryCount === 0) {
      ...
      console.log('--- AUTO-SEED: Gallery seeded');
    }
    ...
    if (testimonialCount === 0) {
      ...
      console.log('--- AUTO-SEED: Testimonials seeded');
    }
    ...
    if (blogCount === 0) {
      ...
      console.log('--- AUTO-SEED: Blog posts seeded');
    }

    // 10. Seed Location Pages
    const locationCount = await LocationPage.countDocuments();
    if (locationCount === 0) {
      ...
      console.log('--- AUTO-SEED: Location pages seeded');
    }
  } catch (error) {
